...
## Project Structure
    ...
    ├── ideapros_llc_cherry_32419  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_cherry_32419`
...
2. Clone this repo and `cd ideapros_llc_cherry_32419`
